...
export function WeatherDashboard({ 
  ...
  const updateActivity = async (activityId: string) => {
    ...
    try {
      ...
      // Create the updated event with all details
      ...
      if (editActivityForm.activity_type === 'Spray Application' && editActivityForm.spray_product) {
        sprayData = {
          product: editActivityForm.spray_product,
          quantity: editActivityForm.spray_quantity,
          unit: editActivityForm.spray_unit,
          target: editActivityForm.spray_target,
          conditions: editActivityForm.spray_conditions,
          equipment: editActivityForm.spray_equipment
        };
      }

      if (editActivityForm.activity_type === 'Irrigation') {
        irrigationData = {
          amount: editActivityForm.irrigation_amount,
          unit: editActivityForm.irrigation_unit,
          method: editActivityForm.irrigation_method,
          duration: editActivityForm.irrigation_duration
        };
      }

      if (editActivityForm.activity_type === 'Fertilization') {
        fertilizationData = {
          type: editActivityForm.fertilizer_type,
          npk: editActivityForm.fertilizer_npk,
          rate: editActivityForm.fertilizer_rate,
          unit: editActivityForm.fertilizer_unit,
          method: editActivityForm.fertilizer_method
        };
      }

      if (editActivityForm.activity_type === 'Harvest') {
        harvestData = {
          yield: editActivityForm.harvest_yield,
          unit: editActivityForm.harvest_unit,
          brix: editActivityForm.harvest_brix,
          ph: editActivityForm.harvest_ph,
          ta: editActivityForm.harvest_ta,
          block: editActivityForm.harvest_block
        };
      }

      if (editActivityForm.activity_type === 'Canopy Management') {
        canopyData = {
          activity: editActivityForm.canopy_activity,
          intensity: editActivityForm.canopy_intensity,
          side: editActivityForm.canopy_side,
          stage: editActivityForm.canopy_stage
        };
      }

      if (editActivityForm.activity_type === 'Scouting' || editActivityForm.activity_type === 'Pest') {
        scoutData = {
          focus: editActivityForm.scout_focus,
          severity: editActivityForm.scout_severity,
          distribution: editActivityForm.scout_distribution,
          action: editActivityForm.scout_action
        };
      }
      ...
      await savePhenologyEvent(
        ...
        editActivityForm.harvest_block || undefined, // harvestBlock for harvest events
        locationData,
        sprayData,
        irrigationData,
        fertilizationData,
                    ...
                    >
                      {isBeingEdited ? (
                        ...
                        <div>
                          ...
                          {/* Event Type Specific Details for Editing */}
                          ...
                          {editActivityForm.activity_type === 'Spray Application' && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                ...
                                <h6 style={{ margin: '0', color: '#92400e', fontSize: '14px', fontWeight: '700' }}>
                                  Spray Application Details
                                </h6>
                              </div>
                              ...
                              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '8px', marginBottom: '8px' }}>
                                ...
                                <div>
                                  ...
                                  <select
                                    value={editActivityForm.spray_unit || 'oz/acre'}
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    placeholder="e.g. Airblast sprayer"
                                    style={{
                                      width: '100%',
                                      padding: '6px 8px',
                                      border: '1px solid #f59e0b',
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    placeholder="e.g. Wind: 5mph, Temp: 72°F"
                                    style={{
                                      width: '100%',
                                      padding: '6px 8px',
                                      border: '1px solid #f59e0b',
                          ...
                          {editActivityForm.activity_type === 'Irrigation' && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                <span style={{ fontSize: '18px' }}>💧</span>
                                <h6 style={{ margin: '0', color: '#00695c', fontSize: '14px', fontWeight: '700' }}>
                                  Irrigation Details
                                </h6>
                              </div>
                              ...
                              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '8px' }}>
                                ...
                                <div>
                                  ...
                                  <select
                                    value={editActivityForm.irrigation_unit || 'inches'}
                          ...
                          {editActivityForm.activity_type === 'Fertilization' && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                <span style={{ fontSize: '18px' }}>🌱</span>
                                <h6 style={{ margin: '0', color: '#365314', fontSize: '14px', fontWeight: '700' }}>
                                  Fertilization Details
                                </h6>
                              </div>
                              ...
                              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '8px' }}>
                                ...
                                <div>
                                  ...
                                  <select
                                    value={editActivityForm.fertilizer_unit || 'lbs/acre'}
                          ...
                          {editActivityForm.activity_type === 'Harvest' && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                <span style={{ fontSize: '18px' }}>🍷</span>
                                <h6 style={{ margin: '0', color: '#991b1b', fontSize: '14px', fontWeight: '700' }}>
                                  Harvest Details
                                </h6>
                              </div>
                              ...
                              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '8px' }}>
                                ...
                                <div>
                                  ...
                                  <select
                                    value={editActivityForm.harvest_unit || 'tons/acre'}
                          ...
                          {editActivityForm.activity_type === 'Canopy Management' && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                <span style={{ fontSize: '18px' }}>🍃</span>
                                <h6 style={{ margin: '0', color: '#065f46', fontSize: '14px', fontWeight: '700' }}>
                                  Canopy Management Details
                                </h6>
                              </div>
                          ...
                          {(editActivityForm.activity_type === 'Scouting' || editActivityForm.activity_type === 'Pest') && (
                            <div style={{
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                                ...
                                <h6 style={{ margin: '0', color: '#064e3b', fontSize: '14px', fontWeight: '700' }}>
